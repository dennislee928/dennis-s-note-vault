...
It has long been debated whether schools should focus more on instructing traditional academic subjects or practical skills. Although advantages of both these two modes are evident, I firmly believe that practical skills can be more useful in students' every life. Advantages of both these modes will be compared in the following paragraphs.
...
It has long been discussed that price of houses has reached a peak that is so expensive that many people cannot purchase or even rent one. Indeed , there are problems caused by this phenomemon, and some measures can be taken to address them. Both potential problems and measure to solve them will be discussed in the following paragraphs.