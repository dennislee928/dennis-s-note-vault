# **Part A — peaked at + less than half + twice as high（各 10 題）**

以下題目全部為 Task 1 風格 → 完全貼近考試。

---

# **A-1. peaked at（10 題）**

任務：用 **peaked at X** 寫一句話（不要 peak to）
...
# **A-2. less than half of that of X（10 題）**

任務：**不要用 a half of** → 要用 **less than half of that of X**

1. Breakfast is 14%; lunch is 32%.
    
2. Gym membership for females is 20%; males 50%.
    
3. Cotton exports are 12%; wool 30%.
    
4. Bike usage is 18%; car usage 45%.
    
5. Children using tablets 22%; using smartphones 60%.
    
6. Books account for 8%; entertainment 20%.
    
7. Recycling rate in City A is 25%; City B is 55%.
    
8. Online shopping is 30%; in-store shopping 70%.
    
9. Train passengers are 40%; subway passengers 88%.
    
10. Renewable energy is 18%; fossil fuels 60%.
    

---

# **A-3. more than twice as high（10 題）**
...
1. Lunch is 32%, breakfast 14%.
    The percentage of lunch is 32%, which is more than twice as high as breakfast, being 14%.
     The percentage of breakfast  is 14%, which is less than half of breakfast, being 32%.
...
6. Energy consumption of industry 60%; residential 25%.
    Energy consumption of industry is 60% which is more than twice as high as residential energy consumption, being 25%.
     Residential  consumption  is 25% ,which is less than half of industrial energy consumption, being 60%.
...
8. Fruit imports 44%; vegetable imports 20%.
    ...
    Vegetable imports is 20% , which is less than half of fruit imports, being 44%.
...
10. Teachers earning 60k; assistants earning 25k.
    ...
    Assistants earning is 25k, which is less tan half of  teachers earning, being 25k.

---

# 🔶 **Part B — 個人化 Modifier 修正練習（20 題）**

全部來自你過去錯誤（paper-made / usage / equipment / tablets ownership / technology-using…）
...
8. technology-using environment
     technological environment/ technology-orientedenvironment
